...
<body>
  ...
  <div class="container" style="max-width: 600px; margin: 5rem auto; padding: 2rem;">
    ...
    <!-- Back Navigation -->
    <a href="view.php?id=<?= $parentId ?>" style="display: inline-flex; align-items: center; gap: 0.5rem; color: var(--color-primary); text-decoration: none; margin-bottom: 1.5rem; font-size: 0.9rem; transition: opacity 0.2s;" onmouseover="this.style.opacity='0.7'" onmouseout="this.style.opacity='1'">
