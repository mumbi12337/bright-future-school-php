...
// Get recent school events (last 5 events)
$events = $eventModel->findBy([], ['created_at' => 'DESC'], 5);

// Get pending fees for linked students
$pendingFees = [];
foreach ($students as $student) {
    $studentPendingFees = $studentFeeModel->getUnpaidFees($student['id']);
    foreach ($studentPendingFees as $fee) {
...
$fees = [];
foreach ($students as $student) {
    $studentFees = $studentFeeModel->getStudentFeeStatus($student['id']);
...
<body>
  ...
  <section id="home" style="min-height: 100vh; padding-top: 5rem;">
    <div class="container">
      ...
      <!-- NEW SECTIONS: EVENTS AND PENDING FEES -->
      <div class="grid-2" style="margin-top: 2rem;">
        <!-- RECENT EVENTS -->
        <div class="card">
          <h3 style="margin-bottom: 1.5rem;">School Events</h3>
          <div class="requirement-list">
            ...
            <div class="requirement-item">
              ...
              <span style="color: var(--color-text); font-weight: 500; flex: 1;">No upcoming events</span>
            </div>
            <?php endif; ?>
          </div>
        </div>
        ...
        <!-- PENDING FEES -->
        <div class="card">
          <h3 style="margin-bottom: 1.5rem;">Pending Fees</h3>
          <table style="width: 100%; border-collapse: collapse;">
            <thead>
              <tr style="background-color: var(--color-surface);">
                <th style="padding: 0.75rem; text-align: left; border-bottom: 1px solid var(--color-border);">Student</th>
            ...
            <tbody>
              ...
              <tr>
                <td colspan="3" style="padding: 0.75rem; text-align: center; color: var(--color-muted);">No pending fees</td>
              </tr>
              <?php endif; ?>
            </tbody>
          </table>
